...
public SafetyGuidelinesView(Connection connection) {
        ...
        // LEFT SIDEBAR: Emergency Contacts (25% width)
        ...
        leftSidebar.getChildren().addAll(sidebarTitle, contactsCard);
        
        // RIGHT AREA: Title, Filter, and Guidelines (75% width)
    ...
    private VBox createEmergencyContactsCard() {
        ...
        contactsGrid.add(createContactItem("CDRRMO", "(053) 561-5027"), 0, 3);
        contactsGrid.add(createContactItem("Fire Dept", "(053) 561-2222"), 0, 1);
        contactsGrid.add(createContactItem("Police", "(053) 561-3333"), 0, 4);
        contactsGrid.add(createContactItem("Hospital", "(053) 255-2316"), 0, 2);
        contactsGrid.add(createContactItem("Medical", "(053) 561-5281"), 0, 5);
